  ...
  return (
    <DashboardLayout>
      ...
      <div className="flex flex-col md:flex-row gap-8 mt-5">
        {data.manager && (
          <div className="col-span-1 inline-flex w-full flex-row items-center shadow-lg rounded-lg p-4">
            <img
        ...
        {data.referrer && (
          <div className="inline-flex w-full flex-row items-center shadow-lg rounded-lg p-4">
            <img
